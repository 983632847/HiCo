...
class ResNet(nn.Module):
    ...
    def forward(self, x):
        ...
        state_dict = torch.load("/home/zhangchunhui/MedicalAI/train_USCL/checkpoints_multi_aug/checkpoint-11/best_model.pth")
        torch.save(state_dict, "best_model_1.pth", _use_new_zipfile_serialization=False)
