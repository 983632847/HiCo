    ...
    for epoch in range(MAX_EPOCH):
        ...
        for i, data in enumerate(train_loader):
            ...
            if (i+1) % log_interval == 0:
                ...
                if epoch == 0:
                    Epoch1_Accuracy.append(correct / total)
        ...
        # # save epoch 1 accuracy: Iteration=1,2,3,...
        # if epoch == 0:
        #     save_dir = os.path.join('results_HiCo')
        #     if not os.path.exists(save_dir):
        #         os.makedirs(save_dir)
        #     resultfile_acc = save_dir + '/Epoch1_Accuracy.txt'
        #     np.savetxt(resultfile_acc, Epoch1_Accuracy, fmt='%0.4f')
...
if __name__ == '__main__':
    # for kk in range(1, 7):    # batch size
    for kk in range(9, 10):  # label rate
    # for kk in range(1, 2):
        parser = argparse.ArgumentParser(description='linear evaluation')
        parser.add_argument('-p', '--path', default='checkpoint_1', help='folder of ckpt')
        args = parser.parse_args()

        set_seed(1)  # random seed

        # parameters
        MAX_EPOCH = 100        # default = 30
        ...
        state_dict_path = "/home/dell/WorkSpace/MedicalAI/HiCo/train_HiCo/checkpoints/HiCo/checkpoint_1/best_model.pth"

        print('State dict path:', state_dict_path)
        fp16_precision = True
        pretrained = True
        selfsup = True    # HiCo, supervised, vanilla
        # selfsup = False   # learning from scratch
        ...
        if not os.path.exists(save_dir):
            os.makedirs(save_dir)
        resultfile = save_dir + '/my_result_{}.txt'.format(kk)
        ...
        if (not (os.path.exists(resultfile))) and (os.path.exists(state_dict_path)):
            ...
            for i in range(1, 6):
                ...
                data_dir = "/Data/Medical_Image_Datasets/test/covid_5_fold/covid_data{}.pkl".format(i)  # POCUS
            ...
            file_handle = open(save_dir + '/my_result_{}.txt'.format(kk), mode='w+')
