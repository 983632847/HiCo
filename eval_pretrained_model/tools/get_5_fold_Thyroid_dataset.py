...
test_data_path = "/Data/Medical_Image_Datasets/test/Thyroid_Dataset/Thyroid"
output_test_data_path = "/Data/Medical_Image_Datasets/test/Thyroid_Dataset/Thyroid_5_fold"
if not os.path.exists(output_test_data_path):
    os.mkdir(output_test_data_path)
...
for sub in test_sub_path:
    if sub == "Thb":
        ...
        for image_name in tqdm(test_images):
            path = os.path.join(test_data_path, sub, image_name, image_name[0:-4]+".png")
...
for fold_N in range(len(Total_train)):
    ...
    write_file = open('/Data/Medical_Image_Datasets/test/Thyroid_Dataset/Thyroid_5_fold/thyroid_5k_data{}.pkl'.format(fold_N+1), 'wb')
