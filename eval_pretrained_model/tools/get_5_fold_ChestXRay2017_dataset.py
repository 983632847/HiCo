...
test_data_path = "/Data/Medical_Image_Datasets/test/ChestXRay2017/chest_xray/test"
output_test_data_path = "/Data/Medical_Image_Datasets/test/ChestXRay2017_5_fold"
if not os.path.exists(output_test_data_path):
    os.mkdir(output_test_data_path)
...
for fold_N in range(len(Total_train)):
    ...
    if not os.path.exists(os.path.join("/Data/Medical_Image_Datasets/test/ChestXRay2017_5_fold")):
        os.mkdir("/Data/Medical_Image_Datasets/test/ChestXRay2017_5_fold")
    write_file = open('/Data/Medical_Image_Datasets/test/ChestXRay2017_5_fold/ChestXRay2017_data{}.pkl'.format(fold_N+1), 'wb')
